...
object SurahDataSource {
    private val surahArabicName = listOf(
        "الفاتحه",
        "البقرة",
        "آل عمران",
        "النساء",
    ...
    private val surahEnglishName = listOf(
        "Al-Fatiha",
        "Al-Baqarah",
        "Aal-E-Imran",
        "An-Nisa'",
    ...
    private val surahVersesNumber = listOf(
        "7",
        "286",
        "200",
        "176",
    ...
    val surahsList : List<SuraDataModel> = mutableListOf<SuraDataModel>().also { surahsList ->
        for ((i, element) in surahArabicName.withIndex()) {
            surahsList.add(SuraDataModel(
                id = (i + 1).toString(),
                suraNameAr = element,
                suraNameEn = surahEnglishName[i],
                versesNumber = surahVersesNumber[i]
            ))
        }
    }.toList()
}